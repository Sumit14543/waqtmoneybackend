...
const mockApplicationFromCrmStatus = (data: any): Application => {
  if (!data) return {};
...
const MakePayment = () => {
  ...
  const [sessionCrmStatus] = useState<any>(() => {
    try {
  ...
  const sessionCrmApplication = sessionCrmStatus
    ...
    : null;
  const effectiveApplication = application
