...
export const startReactAadhaarVerification = async (req, res, next) => {
  try {
    ...
    await checkActiveApplicationInCRM({
      phone: req.body.phone || req.body.mobile || application.mobile,
      mobile: req.body.mobile || req.body.phone || application.mobile,
      email: req.body.email || application.email,
      pan: req.body.pan || req.body.panNumber || req.body.pan_number || application.pan_number,
      panNumber: req.body.panNumber || req.body.pan || req.body.pan_number || application.pan_number,
...
export const handleReactAadhaarCallback = async (req, res) => {
  try {
    ...
    if (!uniqueId && !referenceId) {
      return redirectAadhaarFailure(req, res, "missing_identifier");
    }
